 ...
 * @version 1.0
 */
public class FundCollectionSubWithholdingRelation extends BizObject implements ITenant, IYTenant, AccentityRawInterface {
    // 实体全称
    public static final String ENTITY_NAME = "cmp.fundcollection.FundCollectionSubWithholdingRelation";
     ...
     * @return 资金收款单子表id.ID
     */
    public Long getFundcollectionsubid() {
        return get("fundcollectionsubid");
    }

    /**
     * 设置资金收款单子表id
     *
     * @param fundcollectionsubid 资金收款单子表id.ID
     */
    public void setFundcollectionsubid(Long fundcollectionsubid) {
        set("fundcollectionsubid", fundcollectionsubid);
    }
