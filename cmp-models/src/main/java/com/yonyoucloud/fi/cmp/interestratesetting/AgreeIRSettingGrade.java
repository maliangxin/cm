 ...
 * @version 1.0
 */
public class AgreeIRSettingGrade extends BizObject implements IAuditInfo, ITenant, IYTenant {
	// 实体全称
	public static final String ENTITY_NAME = "cmp.interestratesetting.AgreeIRSettingGrade";
     ...
     * @return 浮动值(加减点)%
     */
	public java.math.BigDecimal getFloatvalueaddsub() {
		return get("floatvalueaddsub");
	}

    /**
     * 设置浮动值(加减点)%
     *
     * @param floatvalueaddsub 浮动值(加减点)%
     */
	public void setFloatvalueaddsub(java.math.BigDecimal floatvalueaddsub) {
		set("floatvalueaddsub", floatvalueaddsub);
	}
