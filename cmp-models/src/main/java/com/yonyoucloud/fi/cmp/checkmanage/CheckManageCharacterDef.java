 ...
 * @version 1.0
 */
public class CheckManageCharacterDef extends BizObject implements ICharacteristcs, IYTenant {
	// 实体全称
	public static final String ENTITY_NAME = "cmp.checkmanage.CheckManageCharacterDef";
