 ...
 * @version 1.0
 */
public class AgreeIRSettingGradeHistory extends BizObject implements IAuditInfo, ITenant, IYTenant {
	// 实体全称
	public static final String ENTITY_NAME = "cmp.withholding.AgreeIRSettingGradeHistory";
     ...
     * 设置协定存款利率变更历史记录子表id
     *
     * @param subid 协定存款利率变更历史记录子表id.ID
     */
