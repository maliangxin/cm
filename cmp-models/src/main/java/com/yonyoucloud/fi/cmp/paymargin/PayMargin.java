 ...
 * @version 1.0
 */
public class PayMargin extends BizObject implements IAuditInfo, IApprovalInfo, ICurrency, IApprovalFlow, IPrintCount, ITenant, IYTenant, AccentityRawInterface {
	// 实体全称
	public static final String ENTITY_NAME = "cmp.paymargin.PayMargin";
	// 业务对象编码
	public static final String BUSI_OBJ_CODE = "ctm-cmp.cmp_paymargin";
		/**
	 * 获取核算会计
	 *
	 * @return 核算会计.ID
     ...
     * @return 预计取回日期
     */
	public java.util.Date getExpectedretrievaldate() {
		return get("expectedretrievaldate");
	}

    /**
     * 设置预计取回日期
     *
     * @param expectedretrievaldate 预计取回日期
     */
	public void setExpectedretrievaldate(java.util.Date expectedretrievaldate) {
		set("expectedretrievaldate", expectedretrievaldate);
	}
     ...
     * 设置支付保证金台账管理特征
     *
     * @param characterDef 支付保证金台账管理特征.ID
     */
	 ...
	 * @return 是否同名账户划转
	 */
	public Short getSamenametransferflag() {
		return getShort("samenametransferflag");
	}

	/**
	 * 设置是否同名账户划转
	 *
	 * @param samenametransferflag 是否同名账户划转
	 */
	public void setSamenametransferflag(Short samenametransferflag) {
		set("samenametransferflag", samenametransferflag);
	}
	/**
	 * 获取内部单位名称
	 *
	 ...
	 * @return 对方关联状态
	 */
	public Short getOppassociationstatus() {
		return getShort("oppassociationstatus");
	}

	/**
	 * 设置对方关联状态
	 *
	 * @param oppassociationstatus 对方关联状态
	 */
	public void setOppassociationstatus(Short oppassociationstatus) {
		set("oppassociationstatus", oppassociationstatus);
	}
	 ...
	 * @return 对方银行对账单id
	 */
	public String getOppbankbillid() {
		return get("oppbankbillid");
	}

	/**
	 * 设置对方银行对账单id
	 *
	 * @param oppbankbillid 对方银行对账单id
	 */
	public void setOppbankbillid(String oppbankbillid) {
		set("oppbankbillid", oppbankbillid);
	}
	 ...
	 * @return 对方认领单id
	 */
	public String getOppbillclaimid() {
		return get("oppbillclaimid");
	}

	/**
	 * 设置对方认领单id
	 *
	 * @param oppbillclaimid 对方认领单id
	 */
	public void setOppbillclaimid(String oppbillclaimid) {
		set("oppbillclaimid", oppbillclaimid);
	}
	 ...
	 * @return 对方勾兑号
	 */
	public String getOppcheckno() {
		return get("oppcheckno");
	}

	/**
	 * 设置对方勾兑号
	 *
	 * @param oppcheckno 对方勾兑号
	 */
	public void setOppcheckno(String oppcheckno) {
		set("oppcheckno", oppcheckno);
	}
	...
	public String getPushtimes() {
		return get("pushtimes");
	}

	/**
	 * 设置推送待结算次数
	 *
	 * @param pushtimes 推送待结算次数
	 */
	public void setPushtimes(String pushtimes) {
		set("pushtimes", pushtimes);
	}
	 ...
	 * @return 新预计取回日期
	 */
	public java.util.Date getNewexpectedretrievaldate() {
		return get("newexpectedretrievaldate");
	}

	/**
	 * 设置新预计取回日期
	 *
	 * @param newexpectedretrievaldate 新预计取回日期
	 */
	public void setNewexpectedretrievaldate(java.util.Date newexpectedretrievaldate) {
		set("newexpectedretrievaldate", newexpectedretrievaldate);
	}
	/**
	 * 获取交易类型标识
	 *
	 ...
	 * 设置轧差识别码
	 *
	 * @param netIdentificateCode 轧差识别码
	 */
	...
	public Short getNetSettleCount() {
		return getShort("netSettleCount");
	}

	/**
	 * 设置轧差结算总笔数
	 *
	 * @param netSettleCount 轧差结算总笔数
	 */
	 ...
	 * @return 轧差后金额
	 */
	public java.math.BigDecimal getAfterNetAmt() {
	 ...
	 * 设置轧差后金额
	 *
	 * @param afterNetAmt 轧差后金额
	 */
	public void setAfterNetAmt(java.math.BigDecimal afterNetAmt) {
	...
	public Short getAfterNetDir() {
		return getShort("afterNetDir");
	}

	/**
	 * 设置轧差后收付方向
	 *
	 * @param afterNetDir 轧差后收付方向
	 */
