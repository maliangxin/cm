 ...
 * @version 1.0
 */
public class PayBillb extends CmpbillEntityDetail implements IUOMInfo, IOriMoneyInfo, INatMoneyInfo, IBackWrite, ITenant {
	// 实体全称
	public static final String ENTITY_NAME = "cmp.paybill.PayBillb";
	 ...
	 * @return 自定义项特征属性组.ID
	 */
	public BizObject getPayBillCharacterDefb() {
		return get("payBillCharacterDefb");
	}

	/**
	 * 设置自定义项特征属性组
	 *
	 * @param payBillCharacterDefb 自定义项特征属性组.ID
	 */
	public void setPayBillCharacterDefb(BizObject payBillCharacterDefb) {
		set("payBillCharacterDefb", payBillCharacterDefb);
	}
