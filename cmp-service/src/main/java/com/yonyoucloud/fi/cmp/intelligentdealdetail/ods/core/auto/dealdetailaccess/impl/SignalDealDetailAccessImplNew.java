...
import com.yonyoucloud.fi.cmp.intelligentdealdetail.ods.core.auto.dealdetailconsumer.impl.SignalDealDetailConsumerNew;
...
@Service
@Slf4j
public class SignalDealDetailAccessImplNew<T> extends ManualDealDetailAccessImpl<T>{
    @Resource
    private SignalDealDetailConsumerNew signalDealDetailConsumerNew;
    @Resource
    ...
    public void notifyConsumer(BankDealDetailModel bankDealDetailModel,Map<String, List<BankDealDetailODSModel>> mapByRepeatStatus){
        ...
        try{
            ...
            signalDealDetailConsumerNew.bankDealDetailConsumer(eventBusModel);
