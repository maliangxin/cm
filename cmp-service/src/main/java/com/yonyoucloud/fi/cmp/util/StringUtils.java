...
public final class StringUtils {
    ...
    public static String joinString(String[] array, String symbol) {
        ...
        if (array != null) {
            ...
            if (result.length() > 1 && ValueUtils.isNotEmpty(symbol)) {
    ...
    public static String join(String linkStr, String... strs) {
        ...
        if (result.length() > 1 && ValueUtils.isNotEmpty(linkStr)) {
   ...
   /* public static String replaceBlank(String str) {
     ...
     * @return
     */
    public static String formatStrNullSafe(String format, Object... args) {
