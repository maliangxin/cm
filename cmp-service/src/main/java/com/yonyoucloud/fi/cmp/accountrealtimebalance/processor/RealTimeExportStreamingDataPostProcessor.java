package com.yonyoucloud.fi.cmp.accountrealtimebalance.processor;
 ...
 */
@Slf4j
@Component("realTimeExportStreamingDataPostProcessor")
public class RealTimeExportStreamingDataPostProcessor implements IExportStreamingDataPostProcessor {

    private static final String CMPRETIBA = "cmp_retibalist";
