...
/**
 * @author qihaoc
 * @Description:公共的供应商参照数据权限过滤
 * @date 2024/11/11 17:24
 */
public class SupplierBankAuthFilter {
    ...
    public  static void filter(BillContext billContext, boolean iscard, String billnum,
        ...
        List<String> suppliers = AuthUtil.getBizObjectAttr(data, IBillConst.SUPPLIER) ;
        if (suppliers != null) {
            filterVO.appendCondition(ConditionOperator.and,new SimpleFilterVO("vendor", "in", suppliers));
        }
    }
}
