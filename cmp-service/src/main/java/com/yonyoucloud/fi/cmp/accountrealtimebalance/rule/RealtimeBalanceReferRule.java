 ...
 *
 */
@Component("realtimeBalanceReferRule")
public class RealtimeBalanceReferRule extends AbstractCommonRule {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        if ("ucfbasedoc.bd_enterprisebankacct".equals(billDataDto.getrefCode()) && "cmp_retibalist".equals(billnum)) {
//             获取授权使用组织
            ...
            if (null != filterVO) {
                ...
                if (null != simpleVOs) {
                    ...
                    if (hasOrgid && hasAccentity) {
                        ...
                        // 通过授权使用组织添加条件
                        addConditionByAuthorizedOrg(billDataDto);
                    }
                } else {
                    // 通过授权使用组织添加条件
                    addConditionByAuthorizedOrg(billDataDto);
        ...
        // 授权使用组织 参照过滤
        if (IRefCodeConstant.FUNDS_ORGTREE_NA.equals(billDataDto.getrefCode()) && "cmp_retibalist".equals(billnum) && "authoruseaccentity".equals(billDataDto.getKey())) {
            // 获取授权使用组织
    ...
    private void addConditionByAuthorizedOrg(BillDataDto billDataDto) throws Exception {
        Set<String> orgs = orgDataPermissionService.queryAuthorizedOrgByServiceCode(IServicecodeConstant.RETIBALIST);
