package com.yonyoucloud.fi.cmp.billclaim.dto;
...
public class MessageResultVO {
    ...
    public MessageResultVO(Map<String, String> failed, List<String> messages, int count, int sucessCount, int failCount) {
        this.failed = failed;
