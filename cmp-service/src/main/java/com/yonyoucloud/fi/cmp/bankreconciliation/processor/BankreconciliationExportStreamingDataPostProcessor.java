 ...
 */
@Slf4j
@Component("bankreconciliationExportStreamingDataPostProcessor")
public class BankreconciliationExportStreamingDataPostProcessor implements IExportStreamingDataPostProcessor {

    private static final String CMPBANKRECON = "cmp_bankreconciliationlist";
    ...
    public boolean accept(BillDataDto billDataDto, List list) {
        ...
        if (CMPBANKRECON.equals(billnum)) {
            return true;
        }
        return false;
    }
