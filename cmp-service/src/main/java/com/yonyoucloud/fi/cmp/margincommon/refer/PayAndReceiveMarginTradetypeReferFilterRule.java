...
@Slf4j
@Component
public class PayAndReceiveMarginTradetypeReferFilterRule extends AbstractCommonRule {
    ...
    public PayAndReceiveMarginTradetypeReferFilterRule() {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        try {
            ...
            if (billnum.equals(IBillNumConstant.CMP_PAYMARGIN) || billnum.equals(IBillNumConstant.CMP_PAYMARGINLIST)) {
                conditionGroup.appendCondition(QueryCondition.name("form_id").eq(ICmpConstant.CM_CMP_PAYMARGIN));
            } else if (billnum.equals(IBillNumConstant.CMP_RECEIVEMARGIN) || billnum.equals(IBillNumConstant.CMP_RECEIVEMARGINLIST)) {
            ...
            if (BILLNUM_MAP.contains(billnum)) {
                if (billDataDto.getCondition() == null) {
                    ...
                    if (IRefCodeConstant.TRANSTYPE_BD_BILLTYPERE_LOCAL.equals(refentity.code) || IRefCodeConstant.TRANSTYPE_BD_BILLTYPEREF.equals(refentity.code)) {
