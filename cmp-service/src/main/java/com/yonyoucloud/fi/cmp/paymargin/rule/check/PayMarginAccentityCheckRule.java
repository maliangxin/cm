package com.yonyoucloud.fi.cmp.paymargin.rule.check;
...
/**
 * 支付保证金 会计主体，交易类型等默认值查询校验
 */
@Slf4j
@RequiredArgsConstructor
@Component
public class PayMarginAccentityCheckRule extends AbstractCommonRule {
...
//            throw new CtmException(new com.yonyoucloud.fi.cmp.common.CtmErrorCode("033-502-100769"),"未获取到默认的交易类型！");
        }
    }
