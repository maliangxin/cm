 ...
 * @author guoxh
 */
@Component("flowHandleSettingBeforeDeleteRule")
@Slf4j
public class FlowHandleSettingBeforeDeleteRule  extends AbstractCommonRule {
    @Override
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        if(bizObject.get("enable") != null && "1".equals(bizObject.getString("enable"))){
        ...
        if(bizObject.get("isSystem")!= null && "1".equals(bizObject.getString("isSystem"))){
