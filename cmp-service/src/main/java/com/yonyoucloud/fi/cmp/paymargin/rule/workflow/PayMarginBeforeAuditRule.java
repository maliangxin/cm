...
@Slf4j
@Component
public class PayMarginBeforeAuditRule extends AbstractCommonRule {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> map) throws Exception {
        ...
        for (BizObject bizobject : bills) {
            ...
            try {
                ...
                log.info("PayMarginBeforeAuditRule bizObject, id = {}, pubTs = {}", bizobject.getId(), bizobject.getPubts());
                PayMargin currentBill = MetaDaoHelper.findById(PayMargin.ENTITY_NAME, bizobject.getId());
                log.info("PayMarginBeforeAuditRule currentBill, id = {}, pubTs = {}", currentBill.getId(), currentBill.getPubts());
                if (currentBill == null) {
                ...
                throw new CtmException(new com.yonyoucloud.fi.cmp.common.CtmErrorCode("033-502-100071"),e.getMessage());
            }
            // 新增：最终释放锁
            finally {
