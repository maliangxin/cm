package com.yonyoucloud.fi.cmp.bankreceipt.processor;
 ...
 */
@Slf4j
@Component("bankReceiptExportStreamingDataPostProcessor")
public class BankReceiptExportStreamingDataPostProcessor implements IExportStreamingDataPostProcessor {

    private static final String CMPBANKELEC = "cmp_bankelectronicreceiptlist";
