...
/**
 * @description: 自动生单确认页面 异步批量拒绝
 * @author: wanxbo@yonyou.com
 * @date: 2022/8/2 14:29
 */
@Component
public class AutoPushBatchRefuseRule extends AbstractCommonRule {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> map) throws Exception {
        ...
        if (bills != null && bills.size() > 0) {
            ...
            if (!ValueUtils.isNotEmptyObj(id)) {
                throw new CtmException(new com.yonyoucloud.fi.cmp.common.CtmErrorCode("033-502-100401"),com.yonyou.iuap.ucf.common.i18n.InternationalUtils.getMessageWithDefault("UID:P_CM-BE_17FE8C5404180060","操作的单据ID不能为空！") /* "操作的单据ID不能为空！" */);
            }
            ...
            try {
                bankAutoPushBillService.refuseBill(params);
            }catch (Exception e){
                throw new CtmException(new com.yonyoucloud.fi.cmp.common.CtmErrorCode("033-502-100402"),String.format("%s:%s",bills.get(0).getString("bank_seq_no"),e.getMessage()));
            }
        }
